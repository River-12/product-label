...
namespace Riverstone\ProductLabel\Block\Adminhtml\Label\Tab;
...
class Conditions extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('Riverstone_ProductLabel');
     ...
     * Add Tab to Form
     *
     * @param \Riverstone\ProductLabel\Model\ProductLabels $model
    ...
    protected function addTabToForm(
        ...
        $formName = 'riverstone_product_label_form'
    ) {
        /** @var \Magento\Framework\Data\Form $form */
